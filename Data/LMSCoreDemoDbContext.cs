...
namespace LMSCoreDemo.Data
{
    public class LMSCoreDemoDbContext:DbContext
    {
        public LMSCoreDemoDbContext(DbContextOptions<LMSCoreDemoDbContext> options): base(options)
        {
